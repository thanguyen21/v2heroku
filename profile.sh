...
#
# This script will allow you to install Ubuntu on your Device with just a few taps
# This script is also portable, all links, repos will be read on a single file So
# to make it easier to fork
#
# Also you will need to comply the GPLv3 license as some components use that
# All Rights Reserved (2020, 2021-2022) made by @trungtai33
#
	...
	function checking_distribution() {
	...
	function download_distribution() {
		...
		"https://partner-images.canonical.com/core/focal/current/ubuntu-focal-core-cloudimg-${arch}-root.tar.gz"; then
	...
	create_ld.so.preload
	create_profile
	create_resolv.conf
	create_hosts
	create_group_gshadow
	create_loadavg
	create_stat
	create_uptime
	create_vmstat
